...
export const NavigationHeader = ({
  ...
  return (
    <header className="bg-white border-b border-gray-200 h-16 lg:h-15 flex items-center justify-between px-6 lg:px-6">
      <div className="lg:hidden flex items-center justify-between w-full">
          ...
          <div className="bg-white border border-gray-300 rounded-lg px-4 py-2">
            <div className="flex items-center space-x-2">
              <div className="relative">
                <h1 className="text-xl font-bold" style={{ color: '#064283' }}>
                  Temporary
                </h1>
              </div>
            </div>
        ...
        <Button
          variant="ghost"
          size="icon"
          className="text-gray-600 hover:text-gray-800 relative h-12 w-12"
        >
          <Bell className="h-6 w-6" />
          <span
            className="absolute -top-1 -right-1 bg-yellow-400 text-xs rounded-full h-6 w-6 flex items-center justify-center font-semibold"
            style={{ color: '#112d52' }}
          >
            8
          </span>
