...
export const ChatWindow = ({
  ...
  return (
    <div className="flex flex-col bg-gray-50 p-4 h-full overflow-hidden">
      {/* Modern Card Header */}
      ...
      <div
        ...
        className="flex-1 overflow-y-auto bg-white rounded-xl shadow-sm border border-gray-100 p-6 mb-4 min-h-0"
      >
